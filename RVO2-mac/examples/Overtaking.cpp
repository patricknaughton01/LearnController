...
void setupScenario(RVO::RVOSimulator *sim)
{
    ...
    RVO::Vector2 position1(randomize(-2.0f, -1.5f), randomize(-2.0f, -1.5f));
    RVO::Vector2 position2(randomize(-1.0f, -0.5f), randomize(-1.0f, -0.5f));
    RVO::Vector2 goal(randomize(2.0f, 3.0f), randomize(2.0f, 3.0f));

	sim->addAgent(position1, 15.0f, 10, 5.0f, 5.0f, randomize(0.15f, 0.25f), randomize(1.5f, 2.0f));
	goals.push_back(goal);
    
    sim->addAgent(position2, 15.0f, 10, 5.0f, 5.0f, randomize(0.15f, 0.25f), randomize(0.0f, 0.4f));
	goals.push_back(goal);


    RVO::Vector2 position3(randomize(-2.0f, 2.0f), randomize(-2.0f, 2.0f));
    sim->addAgent(position3, 15.0f, 10, 5.0f, 5.0f, randomize(0.15f, 0.25f), randomize(0.0f, 0.8f));
    RVO::Vector2 goal3(randomize(-2.0f, 2.0f), randomize(-2.0f, 2.0f));
	goals.push_back(goal3);

    // RVO::Vector2 position4(randomize(-1.0f, 1.0f), randomize(-2.0f, 3.0f));
    // sim->addAgent(position4, 15.0f, 10, 5.0f, 5.0f, randomize(0.15f, 0.25f), randomize(0.0f, 0.8f));
	// RVO::Vector2 goal4(randomize(-1.0f, 1.0f), randomize(-2.0f, 3.0f));
...
{   
    ...
    std::string exp_name = "Overtaking_two_people";
    if (argc == 3) {
