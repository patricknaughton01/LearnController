...
python test.py \
--max_timesteps 0 --num_episodes 10 --scene dynamic_barge_in \
--success_max_ts 10 \
...
--reverse_path learn_general_controller/log/sim_barge_in_short_safe_2_train3_single/seed_1_bootstrap_False_M_1_reverse_True/model_m_0.tar \
