...
python test.py \
--max_timesteps 0 --num_episodes 10000 --scene dynamic_barge_in_success \
--success_max_ts 10 \
...
--reverse_path learn_general_controller/log/sim_barge_in_short_safe_2_train3_2/seed_1_bootstrap_False_M_1_reverse_True/model_m_0.tar \
