...
def main():
    ...
    val_seq_lengths = np.load(parent_path + '/val_seq_lengths.npy', allow_pickle=True)
    val_pred = np.load(parent_path + '/val_pred_x.npy', allow_pickle=True)
    
    val_var = np.load(parent_path + '/val_var_x.npy', allow_pickle=True)
    val_data_uncertainty = np.load(parent_path + '/val_data_uncertainty.npy', allow_pickle=True)
    val_model_uncertainty = np.load(parent_path + '/val_model_uncertainty.npy', allow_pickle=True)
