...
/*
 * Example file showing a robot fail to barge past four human agents in a
 * narrow corridor.
 */
...
std::vector<std::vector<RVO::Vector2> > setupScenario(RVO::RVOSimulator *sim)
{
	 ...
	 *
	 * Add human agents with goals near their start positions so they don't
	 * move out of the way
	 */
    ...
    if (VERTICAL_WALL) {
        ...
        RVO::Vector2 human_goal1(randomize(wall_width + 0.1f, wall_width + wall_dist / NUM_PEOPLE - 0.1f),
                                randomize(wall_length + 0.2f, wall_length + 0.7f));
        ...
        RVO::Vector2 human_goal2(randomize(wall_width + wall_dist / NUM_PEOPLE + 0.1f, wall_width + wall_dist / NUM_PEOPLE * 2 - 0.1f),
                                randomize(wall_length - 0.2f, wall_length + 0.3f));

        RVO::Vector2 human_pos3(randomize(wall_width + wall_dist / NUM_PEOPLE * 2 + 0.1f, wall_width + wall_dist - 0.1f),
                                randomize(wall_length + 0.2f, wall_length + 0.7f));
        RVO::Vector2 human_goal3(randomize(wall_width + wall_dist / NUM_PEOPLE * 2 + 0.1f, wall_width + wall_dist - 0.1f),
                                randomize(wall_length + 0.2f, wall_length + 0.7f));

        RVO::Vector2 human_pos4(randomize(wall_width + wall_dist / NUM_PEOPLE * 3 + 0.1f, wall_width + wall_dist - 0.1f),
                                randomize(wall_length - 0.2f, wall_length + 0.3f));
        RVO::Vector2 human_goal4(randomize(wall_width + wall_dist / NUM_PEOPLE * 3 + 0.1f, wall_width + wall_dist - 0.1f),
                                randomize(wall_length - 0.2f, wall_length + 0.3f));
        ...
        RVO::Vector2 human_goal1(human_pos1.x(),
                                 human_pos1.y());
        ...
        RVO::Vector2 human_goal2(human_pos2.x(),
                                 human_pos2.y());
        ...
        RVO::Vector2 human_goal3(human_pos3.x(),
                                 human_pos3.y());
        ...
        RVO::Vector2 human_goal4(human_pos4.x(),
                                 human_pos4.y());


        sim->addAgent(robot_pos, 1.0f, 10, 5.0f, 5.0f, 0.22f, randomize(1.5f, 2.0f));
        goals.push_back(robot_goal);

        sim->addAgent(human_pos1, 1.0f, 10, 5.0f, 5.0f, 0.22f, randomize(0.1f, 0.4f));
        goals.push_back(human_goal1);

        sim->addAgent(human_pos2, 1.0f, 10, 5.0f, 5.0f, 0.22f, randomize(0.1f, 0.4f));
        goals.push_back(human_goal2);

        sim->addAgent(human_pos3, 1.0f, 10, 5.0f, 5.0f, 0.22f, randomize(0.1f, 0.4f));
        goals.push_back(human_goal3);

        sim->addAgent(human_pos4, 1.0f, 10, 5.0f, 5.0f, 0.22f, randomize(0.1f, 0.4f));
        goals.push_back(human_goal4);
    }
